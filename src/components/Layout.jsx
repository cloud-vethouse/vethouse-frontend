...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {/* 1. SE AGREGA print:hidden AL SIDEBAR */}
      <aside className={`${isSidebarOpen ? 'w-64' : 'w-20'} transition-all duration-300 ease-in-out bg-white border-r border-gray-200 flex flex-col print:hidden`}>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* 2. SE AGREGA print:hidden AL HEADER */}
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-4 justify-between print:hidden">
          <button 
        ...
        {/* Main Area (El contenido principal NO lleva print:hidden para que sí se imprima) */}
